      ...
      <div className="container mx-auto py-8 md:py-12 space-y-12">
        ...
        <Card className="shadow-lg">
          <CardContent className="pt-6 space-y-6 text-muted-foreground text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-foreground mb-2">7. Prohibited Activities & Account Termination</h2>
              <p>
                You are expressly prohibited from using the Service for any unlawful purpose. Violation of these terms may result in the immediate suspension or termination of your account without notice. Prohibited activities include, but are not limited to:
              </p>
              <ul className="list-disc list-inside space-y-2 pl-4 mt-2">
                <li>Using the Service for any illegal purpose or in violation of any local, state, national, or international law.</li>
                <li>Sharing your account credentials or allowing others to access your account. Subscriptions are for individual use only.</li>
                ...
                <li>Attempting to reverse-engineer, decompile, hack, disable, interfere with, or otherwise circumvent any security or technological measure of the Service or its AI models.</li>
                <li>Uploading malicious content, including viruses, worms, or any other code of a destructive nature.</li>
                <li>Engaging in any form of fraudulent activity, including payment fraud or misrepresentation of identity.</li>
                <li>Reselling or commercially exploiting the analysis, predictions, or any other content generated by the Service without our express written permission.</li>
              </ul>
              <p className="mt-2">
